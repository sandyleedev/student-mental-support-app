        ...
        <div className="mb-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 px-6 py-3 bg-teal-600 text-white rounded-2xl hover:shadow-lg transition-all duration-200 font-medium"
            >
            ...
            <div className="flex-1">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-2.5 border border-gray-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                />
              </div>
            </div>
          </div>
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-full font-medium transition-all duration-200 ${
                  selectedCategory === category.id
                    ...
                    : "bg-white text-gray-700 border border-gray-200 hover:border-teal-500 hover:bg-teal-50"
                }`}
              >
        ...
        {isLoading ? (
                ...
                <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
                  ...
                  <div className="flex items-center gap-2 lg:flex-col lg:items-stretch">
                    <button
                      ...
                      className="flex items-center justify-center gap-2 px-4 py-2 bg-teal-50 text-teal-600 rounded-xl hover:bg-teal-100 transition-colors text-sm font-medium"
                    >
                    ...
                    <button
                      ...
                      className="flex items-center justify-center gap-2 px-4 py-2 bg-red-50 text-red-600 rounded-xl hover:bg-red-100 transition-colors text-sm font-medium"
                    >
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-gray-200 p-12 text-center">
            <div className="max-w-md mx-auto">
              <div className="w-24 h-24 mx-auto bg-linear-to-br from-teal-100 to-green-100 rounded-full flex items-center justify-center mb-6">
                <Search className="w-12 h-12 text-teal-500" />
              </div>
              <h3 className="text-2xl text-gray-900 mb-3">No FAQs found</h3>
              ...
              {!searchQuery && (
                <button
                  onClick={() => setShowAddModal(true)}
                  className="px-8 py-3 bg-teal-600 text-white rounded-2xl font-medium shadow-lg hover:shadow-xl transition-all duration-200"
                >
                  Add Your First FAQ
                </button>
              )}
            ...
            <div className="sticky bottom-0 bg-gray-50 border-t border-gray-200 px-8 py-6 rounded-b-3xl">
              <div className="flex items-center justify-end gap-3">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-6 py-2.5 bg-teal-600 text-white rounded-xl hover:shadow-lg transition-all duration-200 font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                >
